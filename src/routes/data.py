...
async def upload_data(request: Request, project_id: int, file:UploadFile, # request allow us to access the app (in main) in inner route 
...
async def process_endpoint( request: Request ,project_id: int, process_request: ProcessRequest):
    ...
    for asset_id,file_id in project_files_ids.items():
        ...
        # we want to convert the file chunk into object of model chunk 
        file_chunks_records=[
            DataChunk(
    ...
    return JSONResponse(
        content={
            "signal":ResponseSignal.PROCESSING_SUCCCESS.value,
